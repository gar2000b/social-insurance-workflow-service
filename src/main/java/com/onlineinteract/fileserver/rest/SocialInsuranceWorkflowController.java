...
public class SocialInsuranceWorkflowController {
	...
	public ResponseEntity<String> verifySin(@RequestBody Map<String, String> customer) {
		 ...
		 * Fetch Customer
		 */
		String customerServiceUrl = "http://localhost:8082/fetchCustomer/" + customer.get("CustomerId");
		 ...
		 * Fraud Check
		 */
		String fraudCheckServiceUrl = "http://localhost:8083/fraudCheck";
		...
		String socialInsuranceVerificationUrl = "http://localhost:8084/verifySin";
